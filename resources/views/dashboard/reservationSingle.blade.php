            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <p class="card-text"><strong>Room: </strong>{{ $reservation->chambre['type'] }}</p>
                        <p class="card-text"><strong>Guests: </strong>{{ $reservation->num_of_guests }}</p>
                        <p class="card-text"><strong>Price: </strong>${{ $reservation->chambre['price'] }}</p>
                    </div>
                </div>
                <div class="text-center mt-3">
                    <a href="/dashboard/reservations/edit/{{ $reservation->id }}" class="btn btn-lg btn-success">Edit this reservation</a>
                    <a href="/dashboard/reservations/delete/{{ $reservation->id }}" class="btn btn-lg btn-danger">Delete</a>
                </div>
            </div>
        </div>
    </div>
